local L = BigWigs:NewBossLocale("Karazhan Trash", "esES") or BigWigs:NewBossLocale("Karazhan Trash", "esMX")
...
L = BigWigs:NewBossLocale("Attumen the Huntsman", "esES")
if L then
	L.IntangiblePresence = "Presencia intangible"
end
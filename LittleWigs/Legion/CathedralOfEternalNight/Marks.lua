...
local mod, CL = BigWigs:NewBoss("=> AutoMarks <=       ", 1677)
...
if L then
	...
	L.custom_off_Mob1 = "Helblaze Soulmender"
	L.custom_off_Mob2 = "Dreadhunter"
	L.custom_off_Mob3 = "Felborne Botanist"
	L.custom_off_Mob4 = "Helblaze Felbringer"
	L.custom_off_Mob5 = "Hellblaze Temptress"
	L.custom_off_Mob6 = "Felstrider Orbcaster"
	L.custom_off_Mob7 = "Nal'asha"
end
--------------------------------------------------------------------------------
-- Locals
--
...
function mod:OnBossEnable()
	...
	self:Death("MarkDeath", 119923, 121553, 118703, 118724, 120779, 118714, 120366, 118713, 118705)
...
do
	function mod:AutoMarks(event, unit, guid)
		...
		if self:GetOption("custom_on_Allowmarks") and ((self:GetOption("custom_off_CombatMarking") and UnitAffectingCombat(unit)) or not self:GetOption("custom_off_CombatMarking")) then
			if (self:GetOption("custom_off_Mob1") and mobID == 119923) or (self:GetOption("custom_off_Mob2") and mobID == 121553) or (self:GetOption("custom_off_Mob3") and mobID == 118703) or (self:GetOption("custom_off_Mob4") and (mobID == 118724 or mobID == 120779)) or (self:GetOption("custom_off_Mob5") and (mobID == 118714 or mobID == 120366)) or (self:GetOption("custom_off_Mob6") and mobID == 118713) or (self:GetOption("custom_off_Mob7") and mobID == 118705) then
				for i = 1, 7 do

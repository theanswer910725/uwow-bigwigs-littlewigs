...
if L then
	...
	L.InfernalTome = "Фолиант: 10% дэф"
	L.MagicalLantern = "Светильник: +10% урона"
	L.NightshadeRefreshments = "Закуски: +25% макс хп"
	L.StarlightRoseBrew = "Отвар: реген хп/мп"
	L.UmbralBloom = "Цветок: +10% скорости"
	L.WaterloggedScroll = "Свиток: +30% мув спид"
	L.BazaarGoods = "Товары: мини-босс"
	L.LifesizedNightborneStatue = "Статуя: мини-босс"
	L.DiscardedJunk = "Хлам: мини-босс"
	L.WoundedNightborneCivilian = "Раненый: мини-босс"
...
if L then
	...
	L.warmup_trigger2 = "Великий магистр, не слишком ли рано?"
end

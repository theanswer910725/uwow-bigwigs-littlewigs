...
local mod, CL = BigWigs:NewBoss("=> AutoMarks <= ", 1492)
...
if L then
	...
	L.custom_off_Mob1 = "Seacursed Slaver"
	L.custom_off_Mob2 = "Night Watch Mariner"
	L.custom_off_Mob3 = "Helarjar Champion"
	L.custom_off_Mob4 = "Shackled Servitor"
	L.custom_off_Mob5 = "Destructor Tentacle"
end
--------------------------------------------------------------------------------
-- Locals
--
...
function mod:OnBossEnable()
	...
	self:Death("MarkDeath", 97043, 97182, 97097, 98693, 99801)
...
do
	function mod:AutoMarks(event, unit, guid)
		...
		if self:GetOption("custom_on_Allowmarks") and ((self:GetOption("custom_off_CombatMarking") and UnitAffectingCombat(unit)) or not self:GetOption("custom_off_CombatMarking")) then
			if (self:GetOption("custom_off_Mob1") and mobID == 97043) or (self:GetOption("custom_off_Mob2") and mobID == 97182) or (self:GetOption("custom_off_Mob3") and mobID == 97097) or (self:GetOption("custom_off_Mob4") and mobID == 98693) or (self:GetOption("custom_off_Mob5") and mobID == 99801) then
				for i = 1, 7 do
